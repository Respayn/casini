 ...
 * 
 * Код библиотеки скопирован и откорректирован в соответствии с проектом (20.04.2025)
 * 
...
class MegaplanRequest
{
    ...
    public function get($Uri, ?array $Params = null)
    {
        ...
        $request = MegaplanRequestInfo::create('GET', $this->host, $Uri, array('Date' => $date->format('r')));
    ...
    public function post($Uri, ?array $Params = null)
    {
        ...
        $request = MegaplanRequestInfo::create('POST', $this->host, $Uri, $headers);
     ...
     * @author megaplan
     * @param MegaplanRequestInfo $Request Параметры запроса
     * @return string Ответ на запрос
     */
    protected function send(MegaplanRequestInfo $Request)
    {
     ...
     */
    public static function calcSignature(MegaplanRequestInfo $Request, $SecretKey)
    {
