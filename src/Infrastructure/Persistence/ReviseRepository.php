...
use Src\Application\Revise\GetData\ReviseGetDataDto;

class ReviseRepository implements ReviseRepositoryInterface
{
    // private Direct $yandexDirectService;
    ...
    {
        // $this->yandexDirectService = new Direct(Setting::getValue('ya_direct_token'));
    ...
    // {
    //     $managers = User::role([RolesEnum::MANAGER, RolesEnum::MANAGER_DEPARTMENT_HEAD])
    //         ->with([
    //             'paymentOperations' => [
    //                 'project',
    //                 'channel'
    ...
    //                 $this->yandexDirectService->clientLogin = $project->direct_login;
    //                 $report = $this->yandexDirectService->getProjectSpendings($periodFrom, $periodTo);
