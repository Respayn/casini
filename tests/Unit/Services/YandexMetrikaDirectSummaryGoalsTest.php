...
class YandexMetrikaDirectSummaryGoalsTest extends TestCase
{
    #[Test]
    public function test_fetch_applies_direct_filter_and_sums_metrics(): void
    {
        $captured = [];
        ...
        $rows = $service->fetchDirectSummaryGoalsStats(
    ...
    #[Test]
    public function test_fetch_uses_month_dimension_for_multi_month(): void
    {
        $captured = [];
        $client = Mockery::mock(YandexMetrikaClientInterface::class);
        $client->shouldReceive('getVisitsReport')
    ...
    public function test_count_for_date_sums_all_goals(): void
    {
        ...
        $count = $this->makeService($client)->countDirectSummaryGoalsForDate([
            'oauth_token' => 'token',
