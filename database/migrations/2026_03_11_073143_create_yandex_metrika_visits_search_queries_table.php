...
return new class extends Migration
{
    ...
    {
        Schema::create('yandex_metrika_visits_search_queries', function (Blueprint $table) {
            $table->comment('Статистика визитов по поисковым запросам из Яндекс.Метрики');
            ...
            $table->unique(['project_id', 'month', 'phrase'], 'project_month_phrase_unique');
    ...
    {
        Schema::dropIfExists('yandex_metrika_visits_search_queries');
    }
};
