...
<head>
    <meta charset="utf-8">
    <title>Яндекс.Директ — авторизация</title>
</head>
<body>
    ...
    <script>
        (function () {
            ...
            try {
                if (cacheDataId) {
                    localStorage.setItem('casini_yandex_direct_oauth_done', cacheDataId);
            ...
            setTimeout(function () {
                ...
                // Safari / встроенные браузеры часто игнорируют window.close()
