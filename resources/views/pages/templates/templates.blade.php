                            ...
                            <x-data.table-row>
                                ...
                                <x-data.table-cell>
                                    <div class="flex gap-2">
                                        <x-button.button wire:click="download({{ $template->getId() }})" icon="icons.download" title="Скачать"></x-button.button>
                                        <x-button.button wire:confirm="Удалить шаблон?" wire:click="delete({{ $template->getId() }})" icon="icons.delete" title="Удалить"></x-button.button>
                                    </div>
                                </x-data.table-cell>
                            </x-data.table-row>
                        @endforeach
