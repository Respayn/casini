        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-4">
                ...
                <x-form.form-field>
                    ...
                    <x-form.input-text wire:model.defer="form.login" placeholder="Логин" />
                </x-form.form-field>

                @if(!isset($form->id))
                    <x-form.form-field>
                        <x-form.form-label required tooltip="Минимум 8 символов">Пароль</x-form.form-label>
                        <x-form.input-text type="password" wire:model.defer="form.password" placeholder="Пароль" />
                    </x-form.form-field>
                    <x-form.form-field>
                        <x-form.form-label required>Повторить пароль</x-form.form-label>
                        <x-form.input-text type="password" wire:model.defer="form.password_confirmation" placeholder="Повторите пароль" />
                    </x-form.form-field>
                @endif
            ...
            <div class="flex flex-col gap-4">
                ...
                <x-form.form-field>
                    ...
                    <x-form.input-text wire:model.defer="form.first_name" placeholder="Имя" />
                </x-form.form-field>

                <x-form.form-field>
                    <x-form.form-label>Фамилия</x-form.form-label>
                    <x-form.input-text wire:model.defer="form.last_name" placeholder="Фамилия" />
                </x-form.form-field>

                <x-form.form-field>
                    <x-form.form-label required tooltip="Email для авторизации и уведомлений">Email</x-form.form-label>
                    <x-form.input-text wire:model.defer="form.email" type="email" placeholder="email@siteactiv.ru" />
                </x-form.form-field>

                <x-form.form-field>
                    <x-form.form-label>Телефон</x-form.form-label>
                    <x-form.input-text wire:model.defer="form.phone" placeholder="+7 (999) 123-45-67" />
                </x-form.form-field>
            ...
            <x-form.form-field>
                ...
                <x-form.input-text wire:model.defer="form.megaplan_id" placeholder="1000272" />
            </x-form.form-field>

            <x-form.form-field>
                <x-form.form-label>Важные уведомления</x-form.form-label>
                <x-form.toggle-switch wire:model.defer="form.enable_important_notifications" />
            </x-form.form-field>

            <x-form.form-field>
                <x-form.form-label>Обновление сервиса</x-form.form-label>
                <x-form.toggle-switch wire:model.defer="form.enable_notifications" />
            </x-form.form-field>
