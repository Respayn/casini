<div class="flex flex-col gap-3">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2 items-center">
            <x-button.button label="+ Создать клиента" variant="primary" />
            <x-button.button href="{{ route('system-settings.clients-and-projects.projects.create') }}" label="+ Создать клиенто-проект" variant="primary" />
        </div>
    </div>
    <div>
        <x-data.table>
